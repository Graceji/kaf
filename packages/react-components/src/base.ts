...
export const KAFContextComponent = createContext<KAFContext>({
  router: null as any,
});
...
export const setReactComponentsConfig = buildConfigSetter(
  reactComponentsConfig
);

// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
export function useEventCallback<A extends any[]>(
  fn: (...args: A) => void,
  dependencies: any[]
) {
