...
export function setProcessedError(
  error: any,
  processed: boolean
): { [errorProcessed]: boolean; [key: string]: any } {
...
export function moduleLoadingAction(
  moduleName: string,
...
export function testChangeAction(
  location: Location,
...
export function beforeChangeAction(
  location: Location,
  routeAction: RouteAction
): Action {
  return {
...
export function afterChangeAction(
  location: Location,
  routeAction: RouteAction
): Action {
  return {
